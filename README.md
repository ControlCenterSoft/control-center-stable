...
**Текущий Public Stable: 0.32.0.** Официальный релиз `v0.32.0` опубликован с исправленным Linux AMD64 package contract и полным набором release artifacts.
