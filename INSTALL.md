...
7. Выполните bootstrap-вход локального администратора и обязательно завершите смену первоначального пароля при первом входе. До смены пароля обычная работа не разрешается.
...
Пароль существующего администратора при обновлении сохраняется и не сбрасывается к первоначальному значению.
