...
func TestMemoryRegistryListAndGet(t *testing.T) {
	...
	registry, err := NewMemoryRegistry([]Resource{
		{ID: "node-2", OrganizationID: "org-a", Kind: "node", Name: "Node 2", Status: "ready", Revision: 1, CreatedAt: now, UpdatedAt: now},
		{ID: "site-1", OrganizationID: "org-a", Kind: "site", Name: "Site 1", Status: "ready", Revision: 2, CreatedAt: now, UpdatedAt: now},
		{ID: "node-1", OrganizationID: "org-b", Kind: "node", Name: "Node 1", Status: "unknown", Revision: 1, CreatedAt: now, UpdatedAt: now},
	})
	if err != nil {
